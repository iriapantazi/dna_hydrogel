...
def parse_args():
    ...
    Returns: args
    """
    parser = argparse.ArgumentParser(description='generate rigid rods of 10 beads')
    parser.add_argument("-g", "--generate", nargs="+", default=None, help="generate new rigid rods configuration.")
    parser.add_argument("-r", "--replot", nargs="+", help="replot rigid rods configuration from rawdata file.")
...
#    src = "input_data.file"
#    dst = "input_data_nunchucks_"+str(n_molecules)+"_"+str((box_limit)*2)+".file"
#    copyfile(src,dst)
#
#if args.replot:
